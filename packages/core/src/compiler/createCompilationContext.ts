...
export function createCompilationContext(
  ...
  const components: Array<NoCodeComponentDefinition<any, any>> = [
    ...
    {
      id: "@heliumblocks/missing-component",
...
> {
  return {
    space: {
      ...
      widget: { id: "@heliumblocks/space", label: "Space" },
      allowCustom: true,
      validate(value) {
    ...
    color: {
      ...
      widget: { id: "@heliumblocks/color", label: "Color" },
      allowCustom: true,
      validate(value) {
    ...
    aspectRatio: {
      ...
      token: "aspectRatios",
      responsiveness: "always",
      widget: { id: "@heliumblocks/aspectRatio", label: "Aspect ratio" },
    ...
    icon: {
      ...
      widget: { id: "@heliumblocks/icon", label: "Icon" },
      allowCustom: true,
      validate(value) {
...
function ensureDocumentDataWidgetForExternalTypes(
  ...
  externalTypesNames.forEach((externalTypeName) => {
    ...
    const hasDocumentDataWidget = externalTypeDefinition.widgets.some(
      (w) => w.id === "@heliumblocks/document-data"
    );
