...
describe("@heliumblocks/rich-text-part", () => {
  test("builds", () => {
    expect(
      buildRichTextPartComponentConfig({
        color: {
...
describe("@heliumblocks/rich-text-line-element", () => {
  test("builds", () => {
    expect(
      buildRichTextLineElementComponentConfig({
        elements: [],
...
describe("@heliumblocks/rich-text-block-element", () => {
...
describe("@heliumblocks/rich-text", () => {
